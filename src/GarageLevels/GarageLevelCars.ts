...
export const garageLevelList: GarageLevels[] = [
  ...
  },
  {
    ...
    garageLevel: [
      {
        img: Images.DodgeChallenger392HemiScatPk,
      ...
      {
        img: Images.LotusEvoraSport410,
        name: "Lotus Evora Sport 410",
      },
      {
  ...
  },
  {
    ...
    garageLevel: [
      {
        img: Images.MercedesBenzAMGGTS,
        name: "Mercedes-Benz AMG GT S",
      },
      {
        img: Images.Porsche718Cayman,
  ...
  },
  {
    ...
    garageLevel: [
      {
        img: Images.JaguarFTypeSVR,
        name: "Jaguar F-Type SVR",
      },
      {
        img: Images.AstonMartinDB11,
